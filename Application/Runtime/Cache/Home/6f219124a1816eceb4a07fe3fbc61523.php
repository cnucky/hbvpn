...
<script type="text/javascript" src="/hbvpn/Public/Home/theme/default/js/jquery.ajax.js"></script>
</head>
<body>
	
</body>
</html>
<link rel="stylesheet" type="text/css" href="/hbvpn/Public/Home/theme/default/css/login.css" />
<style type="text/css">
.shadow-box{
...
body{
	background: url("/hbvpn/Public/Admin/theme/defalut/images/loginBg.png") no-repeat;
...
<body>
	<div class="loginBg">
	    <form id="loginForm" class="container " action="/hbvpn/Home/Login/login" method="POST" >
    ...
    <script type="text/javascript">
    	$(document).ready(function(){
    		//获取验证码图片
    		$("#checkeImg").attr("src","/hbvpn/Home/Login/getVerify"+'/'+Math.random());
