...
$(function(){
	var tableList="tableList_vpsBusiness";
	var auForm ="addForm_vpsBusiness";
	var saveBtn="saveBtn_vpsBusiness";
	var addDiv="addDiv_vpsBusiness";
	var cancelBtn="cancelBtn_vpsBusiness";
	...
	$("#"+tableList).datagrid({
		...
		url:'/hbvpn/Admin/VpsBusiness/pageList',
		fitColumns:true,
		nowrap:true,
		selectOnCheck:false,
		animate:true,
		...
		iconCls: 'fa fa-easyui fa-plus-square',
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					ajaxDelRowsDatagrid('/hbvpn/Admin/VpsBusiness/delRows',ids,tableList);
				}
			}
		},'-',{
	...
	$("#"+saveBtn).click(function(){
		ajaxSubmitForm(auForm,'/hbvpn/Admin/VpsBusiness/addOrUpdate',addDiv,tableList);
	});
...
<div>
	...
	<table id="tableList_vpsBusiness"></table>

</div>
<div id="addDiv_vpsBusiness" class="easyui-window" title="添加" data-options="iconCls:'fa fa-dot-circle-o',closed:true" style="width:600px;height:360px;padding:5px;">
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'center',border:true">
			<form id="addForm_vpsBusiness" class="easyui-form" method="post" data-options="novalidate:true">
		    	...
		    	<table cellpadding="5">
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<select id="type_vpsBusiness" name="data[type]" class="easyui-combobox" data-options="required:true" style="width:455px;height:30px;" ></select>
		    			</td>
		...
		<div data-options="region:'south',border:false" style="text-align:right;padding:5px 0 0;">
			<a id="saveBtn_vpsBusiness" class="easyui-linkbutton" data-options="iconCls:'fa fa-easyui fa-check'" href="javascript:void(0)" style="width:80px">保存</a>
			<a id="cancelBtn_vpsBusiness" class="easyui-linkbutton" data-options="iconCls:'fa fa-easyui fa-times'" href="javascript:void(0)" style="width:80px">取消</a>
		</div>
	</div>
</div>