...
$(function(){
		...
		iconCls: 'fa fa-easyui fa-plus-square',
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					ajaxDelRowsTreeGrid('/hbvpn/Admin/Node/delRows',ids,tableList);
				}
			}
		},'-',{
	...
	$("#"+saveBtn).click(function(){
		ajaxSubmitFormTreeGrid(auForm,'/hbvpn/Admin/Node/addOrUpdate',addDiv,tableList);
	});
	...
	$('#nodeComboxtree').combotree({
		url:'/hbvpn/Admin/Node/getParent',
		editable:false,
		lines:true,
		method:'get'
	});
