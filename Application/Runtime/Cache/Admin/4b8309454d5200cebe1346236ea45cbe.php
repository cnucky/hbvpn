...
$(function(){
		...
		iconCls: 'fa fa-easyui fa-plus-square',
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					var rows=ajaxReturnList("/hbvpn/Admin/Role/getRoleAccess",o);
					var node=null;
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					ajaxDelRowsDatagrid('/hbvpn/Admin/Role/delRows',ids,tableList);
				}
			}
		},'-',{
	...
	$("#"+saveBtn).click(function(){
		ajaxSubmitForm(auForm,'/hbvpn/Admin/Role/addOrUpdate',addDiv,tableList);
	});
	...
	$("#saveBtn_auth_role").click(function(){
    	...
    	var obj=ajaxReturnList("/hbvpn/Admin/Role/authorization",o);
    	if(obj.flag){
	...
	$('#authTree').tree({
		url:'/hbvpn/Admin/Node/getCombotree',
		editable:true,
		checkbox:true,
		cascadeCheck:false,
