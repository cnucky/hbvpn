...
$(function(){
	...
	$("#"+tableList).datagrid({
		...
		url:'/hbvpn/Admin/Server/pageList',
		fitColumns:true,
		nowrap:true,
		selectOnCheck:false,
		animate:true,
		...
		iconCls: 'fa fa-easyui fa-plus-square',
			...
			handler: function(){
				...
				if(null==selectedRow){
					...
					ajaxDelRowsDatagrid('/hbvpn/Admin/Server/delRows',ids,tableList);
				}
			}
		},'-',{
	...
	$("#"+saveBtn).click(function(){
		ajaxSubmitForm(auForm,'/hbvpn/Admin/Server/addOrUpdate',addDiv,tableList);
	});
